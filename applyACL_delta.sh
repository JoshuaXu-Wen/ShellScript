...
special_user_permissions="/tmp/special_user_permissions_Delta.txt"
special_group_permissions="/tmp/special_group_permissions_Delta.txt"
special_user_script='/tmp/scripts/setUserPermission_Delta.sh'
special_group_script='/tmp/scripts/setGroupPermission_Delta.sh'
